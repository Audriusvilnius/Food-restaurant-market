                                    ...
                                    <form action="{{ route('add-basket') }}" method="post">
                                        <div class="col-md-12 gap-3 align-items-center d-flex justify-content-center">
                                            ...
                                            <div class="col-md-1 ">
                                                ...
                                                <div
                                                    class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-4 g-3">
                                                    @forelse($foods as $key=>$food)
                                                        <div id="{{ $food['id'] }}"
                                                            class="col d-flex justify-content-md-between">
                                                            <div class="card g-0 shadow p-0 bg-body-tertiary rounded">
                                                                <div class="container_pic">
                                                                    <img src="{{ asset($food->photo) }}"
                                                                        class="img-fluid rounded shadow bg-body-tertiary"
                                                                        alt=" hotel">
                                                                    @foreach ($restaurants as $restaurant)
                                                                        @if ($restaurant->id == $food->rest_id && $restaurant->works == 'false')
                                                                            <div style="transform: translateX({{ $restaurant->translateX }}px) translateY({{ $restaurant->translateY }}px) rotate({{ $restaurant->deg }}deg);"
                                                                                ...
                                                                                <div onmouseover="mOver({{ $key }})"
                                                                                    onmouseout="mOut({{ $key }})">
                                                                                    <div class="appBannerT{{ $key }}"
                                                                                        style="display: none;">open
                                                                                        {{ $restaurant->open }}</div>
                                                                                    <div class="appBannerB{{ $key }}"
                                                                                        style="display: inline;">closed
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        @endif
                                                                ...
                                                                <h6 class="mt-3">
                                                                    <i>{{ $food->foodReataurants_name->title }}</i></h6>

                                                                <div class="justify-content-center align-bottom">
                                                                    @if (app()->getLocale() == 'lt')
                                                                        <h4 class="mt-3">
                                                                            <b><i>{{ $food->title_lt }}</b></i></h4>
                                                                    @else
                                                                        <h4 class="mt-3">
                                                                            <b><i>{{ $food->title_en }}</b></i></h4>
                                                                    @endif

                                                                    <h3
                                                                        @if ($food->price < 20) style="color:crimson;" @endif>
                                                                        <b>{{ __('Price') }}: <i>{{ $food->price }}
                                                                                &euro;</b></i></h3>

                                                                    <i>{{ $food->price }} &euro;</b></i></h3>
                                                                    <div class="ms-10">
                                                                        <h5 class="mt-10"><i> {{ __('Rating') }}:</i>
                                                                            </h6>
                                                                            <div id="rating-score">
                                                                                <script>
                                                                        ...
                                                                        <div class="accordion-item">
                                                                            ...
                                                                            <div id="flush-collapseOne"
                                                                                ...
                                                                                <div class="accordion-body ">
                                                                                    ...
                                                                                    <h6>{{ __('City') }}:
                                                                                        <b><i>{{ $food->foodCities_no->title }}</i></b>
                                                                                    </h6>
                                                                                    @if (app()->getLocale() == 'lt')
                                                                                        <h6>{{ __('Category') }}:
                                                                                            <b><i>{{ $food->foodCategory_no->title_lt }}</i></b>
                                                                                    ...
                                                                                    @if (app()->getLocale() == 'lt')
                                                                                        <span
                                                                                            class="text-muted">{{ $food->des_lt }}</span>
                                                                                    @else
                                                                                        <span
                                                                                            class="text-muted">{{ $food->des_en }}</span>
                                                                                    @endif

                                                                                </div>
                                                                                <form
                                                                                    action="{{ route('update-reviews') }}"
                                                                                    method="get">
                                                                                    <div
                                                                                        class="gap-3 align-items-center d-flex justify-content-center mt-3">
                                                                                        <input type="hidden"
                                                                                            name="product"
                                                                                            value="{{ $food->id }}">
                                                                                        <div class="btn-group">
