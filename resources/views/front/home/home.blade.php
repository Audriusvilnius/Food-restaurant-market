...
<div class="page">
    <div class="container ">
        ...
        <div id="carouselExampleControls" class="carousel container shadow_new slide" data-bs-ride="carousel">

            <div class="carousel-inner">
                @foreach($categories as $key => $category)
                <div @if($key==0)class="carousel-item active" @else class="carousel-item" @endif>
                    <div class="cards-wrapper ">
                        <div class="card container_pic">
                            <a class="list-group-item list-group-item-action" href="{{route('list-category',$category->id)}}">
                                <img src="{{asset($category->photo)}}" class="img-fluid rounded" alt="photo">
