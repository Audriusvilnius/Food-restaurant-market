...
@section('content')
    <section class="py-1 text-center container">
        <div class="col-lg-4 col-md-8 mx-auto mt-1 fixed-top py-2">
            @if (Session::has('ok'))
                <h6 class=" alert alert-success alert-dismissible fade show border border-dark border-2" role="alert">
                    {{ Session::get('ok') }}
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header justify-content-center">
                        <h1 class="fs-2">Rate and leave a review about {{ $food->title }} from
                            {{ $food->foodReataurants_name->title }}
                        </h1>
                    </div>
                </div>
                <div class="card mt-2 d-flex justify-content-md-between">
                    <div class="row g-0 shadow p-3 bg-body-tertiary rounded">
                        ...
                        <div class="col-md-6 d-flex fs-5">
                            <div class="card-body">
                                <h6 class="fs-5">Food: <b><i>{{ $food->title }}</b></i></h6>
                                <h6 class="fs-5">Price: <b><i>{{ $food->price }} &euro;</b></i></h6>
                                <h6 class="fs-5">Raiting: <b><i>{{ $food->rating }}</b></i></h6>
                                <h6 class="fs-5">Voted: <b><i>{{ $food->counts }}</b></i></h6>

                                <h6 class="fs-5">City: <b><i>{{ $food->foodReataurants_name->city }}</b></i></h6>
                                <h6 class="fs-5">Restaurant: <b><i>{{ $food->foodReataurants_name->title }}</b></i></h6>
                                <div class="col-md-12 d-flex">
                                    <div class="col-md-6">
                                        <h6 class="fs-5">Open: <b><i>{{ $food->foodReataurants_name->open }}</b></i></h6>
                                    </div>
                                    <div class="col-md-6">
                                        <h6 class="fs-5">Close: <b><i>{{ $food->foodReataurants_name->close }}</b></i>
                                        </h6>
                                    </div>
                                </div>
