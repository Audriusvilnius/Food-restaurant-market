                ...
                <div class="row g-0 shadow p-3 bg-body-tertiary rounded">
                    ...
                    <div class="col-md-4">
                        <div class="card-body ms-2">
                            <h6>Restaurant: <b><i>{{$category->title}}</i></b></h6>

                            <h6>City: <b><i>{{$category->id}}</i></b></h6>
                            ...
                            <h6>Dish qty.: <b><i>{{$restaurant->food_Catagory()->count()}}</i></b></h6>
                    ...
                    <div class="col-md-4">
                        <div class="card-body">
                            ...
                            <div class="list-table__buttons gap-3 mt-3">
                                <a href="{{route('category-edit', $category)}}" class="btn btn-secondary" style="width: 80px;">EDIT</a>
