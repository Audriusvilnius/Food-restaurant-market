                         ...
                         <div class="card-body text-muted">
                             <div class="container">
                                 <div class="row text-start">
                                     ...
                                     <div class="col-md-3">
                                         <small class="fw-lighter">Street:</small>&nbsp;&nbsp; {{ $ovner->street }}
                                         {{ $ovner->build }}<br>
                                         <small class="fw-lighter">City:</small>&nbsp;&nbsp; {{ $ovner->city }}<br>
                                         <small class="fw-lighter">Post: </small>&nbsp;&nbsp;
                                         {{ $ovner->postcode }}<br>
                                         <small class="fw-lighter">Country:</small>&nbsp;&nbsp;
                                         {{ $ovner->country }}<br>
                                     </div>
                                     <div class="col-md-6">
                                         <small class="fw-semibold"><i class="bi bi-globe"></i></small>&nbsp;&nbsp;
                                         {{ $ovner->url }}<br>
                                         <small class="fw-semibold"><i
                                                 class="bi bi-telephone"></i></small>&nbsp;&nbsp;
                                         {{ $ovner->phone }}<br>
                                         <small class="fw-semibold"><i class="bi bi-phone"></small></i>&nbsp;&nbsp;
                                         {{ $ovner->mobile }}<br>
                                         <small class="fw-semibold"><i
                                                 class="bi bi-envelope-at"></i></small>&nbsp;&nbsp;
                                         {{ $ovner->email }}<br>
                                     ...
                                     <div class="col-md-3">
                                         <small class="fw-semibold "><i class="bi bi-bank"></small></i>&nbsp;&nbsp;
                                         {{ $ovner->bank }}<br>
                                         <small class="fw-semibold"><i
                                                 class="bi bi-wallet-fill"></small></i>&nbsp;&nbsp;
                                         {{ $ovner->account }}<br>
                                     </div>
                                 </div>
                             </div>
